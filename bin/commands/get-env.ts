...
function formatEnvVars(vars: Record<string, string>): string {
    ...
    lines.push("# ==============================================================================");
    lines.push("# Generated by: bin/get-env.ts");
...
function printHelp(): void {
    console.log("Usage: node bin/get-env.ts <catalog-url> [options]");
    console.log("");
    ...
    console.log("  node bin/get-env.ts https://nightly.quilttest.com");
    console.log("  node bin/get-env.ts https://nightly.quilttest.com --write");
    console.log("  node bin/get-env.ts https://nightly.quilttest.com --output=env.staging");
    console.log("");
...
async function main(): Promise<void> {
    ...
    try {
        ...
        if (targetFile) {
            ...
            console.log(`  node bin/get-env.ts ${catalogUrl} --write`);
            console.log("=".repeat(80));
            console.log("");
        }
