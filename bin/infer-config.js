#!/usr/bin/env node
/**
 * Infer environment configuration from a Quilt catalog's config.json
 *
 ...
 * 4. Generate environment variables for env.template
 *
 * Usage:
 *   node bin/infer-config.js https://your-catalog.quiltdata.com
 *   node bin/infer-config.js https://your-catalog.quiltdata.com --output .env.inferred
 */
...
function formatEnvVars(vars) {
    ...
    lines.push("# ==============================================================================");
    lines.push("# Generated by: bin/infer-config.js");
 ...
 */
function printHelp() {
    console.log("Usage: node bin/infer-config.js <catalog-url> [options]");
    console.log("");
    ...
    console.log("  --write        Write to .env.inferred by default");
    console.log("  --help, -h     Show this help message");
    console.log("");
    console.log("Examples:");
    console.log("  node bin/infer-config.js https://nightly.quilttest.com");
    console.log("  node bin/infer-config.js https://nightly.quilttest.com --write");
    console.log("  node bin/infer-config.js https://nightly.quilttest.com --output=.env.staging");
    console.log("");
    console.log("Description:");
    console.log("  This script fetches config.json from a Quilt catalog and attempts to infer");
...
async function main() {
    try {
        ...
        if (targetFile) {
            ...
            console.log("  3. Rename to .env or merge with your existing .env file");
            console.log("");
        } else {
            console.log("=".repeat(80));
            console.log("To save this configuration, run:");
            console.log(`  node bin/infer-config.js ${catalogUrl} --write`);
            console.log("=".repeat(80));
            console.log("");
        }
